...
@journalCategory_bp.route('/journal-categories', methods=['GET'])
...
@journalCategory_bp.route('/journal-category/<category_id>', methods=['GET'])
...
@journalCategory_bp.route('/journal-category', methods=['POST'])
...
@journalCategory_bp.route('/journal-category/<category_id>', methods=['PUT'])
...
@journalCategory_bp.route('/journal-category/<category_id>', methods=['DELETE'])
